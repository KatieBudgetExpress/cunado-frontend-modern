(function () {
    ...
    angular.module('i2sFinance.priver.assistant')
        .controller('AssistantRevenusCtrl', AssistantRevenusCtrl);

    /** @ngInject */
    async function AssistantRevenusCtrl($scope,
                                        $rootScope,
                                        uuid,
                                        $translate,
                                        toastr,
        ...
        $scope.remplirData = function () {
          return new Promise((resolve, reject) => {
            let promisePoste = cuServices.viPosteBudgetaire("getParCateg", 1);
        ...
        function ajouterData() {
          const categorie = $rootScope.arrayCategorie.find(categorie => categorie.id === 1);
        ...
        function majData(poste, sousPoste) {
          $scope.categorie = $rootScope.arrayCategorie.find(categorie => categorie.id === 1);
        ...
        $scope.$on('valideSelectionRevenu', function (event, data) {
        ...
        $scope.$on('setBudgetRevenu', function (event, data) {
