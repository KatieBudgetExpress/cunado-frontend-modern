...
},{"./currencies.json":2,"./localeFormats.json":4,"accounting":1,"locale-currency":5,"object-assign":7}],4:[function(require,module,exports){
module.exports={
  "de": {
    "thousandsSeparator": ".",
    "decimalSeparator": ",",
...
},{"./map":6}],6:[function(require,module,exports){
...
(function () {
    ...
    angular.module('i2sFinance.theme').service('cuCurrency', currencyService).filter('cuCurrency', currencyFilter);

    /** @ngInject */
    function currencyFilter(cuCurrency) {
        return (montant, code) => {
            if (typeof code === 'undefined') {
                return cuCurrency.format(montant, code);
            }
            return cuCurrency.format(montant, code);
        };
    }
...
/*
CAD: 10 000,99$ et -10 000,99$
USD: $10,000.99 et -$10,000.99
EUR: 10 000,99€ et -10 000,99€
GBP: £10,000.99 et -£10,000.99
BRL: R$10.000,99 et -R$10.000,99
*/
    const formatCustom = {
        CAD: {
            symbol: '$',
            ...
            precision: 2,
            format: {
                pos: '%v%s', // %s is the symbol and %v is the value
                neg: '-%v%s',
                zero: '%v%s'
            }
        },
    ...
    function format(montant, code = 'CAD') {
        let formatCurrency = formatCustom[code.toUpperCase()];
        if (!formatCustom[code.toUpperCase()]) {
            formatCurrency = {code: code.toUpperCase()};
        }
        return currencyFormatter.format(montant, formatCurrency);
    }

    function unformat(montant, code) {
        return currencyFormatter.unformat(montant, {code: code.toUpperCase()});
    }

    function findCurrency(code) {
        return currencyFormatter.findCurrency(code.toUpperCase());
    }

})();

},{"currency-formatter":3}]},{},[8]);
